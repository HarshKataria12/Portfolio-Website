  ...
  return (
    <section id="education" className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20">
      ...
      <h2 className="text-3xl sm:text-4xl font-bold mb-10 inline-block relative">
        Education
        <span className="absolute left-0 -bottom-3 h-1 w-16 rounded bg-gradient-to-r from-sky-400 to-cyan-300" />
      </h2>
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6 sm:p-8 hover:border-sky-500/60 transition">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          <div>
            <p className="text-sky-400 font-semibold">{education.university}</p>
